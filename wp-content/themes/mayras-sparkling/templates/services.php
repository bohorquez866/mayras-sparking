...
<section class="services_section">
    ...
    <div class="services_lists">
        ...
        <?php
            ...
            $wp_query = new WP_Query($args); ?>
            <?php if($wp_query->have_posts()) : $d = 0 ?>
            <?php while ($wp_query->have_posts()) : $wp_query->the_post(); $d++ ?>
                <div class="services_lists_items" id="service-<?php echo $d;?>">
                    ...
                    <?php while( have_rows('lista_productos') ): the_row(); $c++ ?>
                        <div class="services_lists_item">
                            <h3 class="services_lists_item_title">
                                <?php the_sub_field('titulo_lista_productos'); ?>
                            </h3>
                            <div class="services_lists_item_content"><?php the_sub_field('texto_lista_productos'); ?></div>
                        </div>
                    <?php endwhile; ?>
                    <?php endif; ?>
                </div>
